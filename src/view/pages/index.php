          ...
          <li class="item">
            ...
            <article>
              <div class="infoGradient">
                <p class="dayLabel">vrijdag</p>
                <div class="textLabel">
                  <h3>The Flying Dutchmen<sup> NL </sup></h3>
                  <p class="textLabel__name">The Sky Is The Limit</p>
                </div>
              </div>
              <div class="gradient">
            ...
            <article>
              <div class="infoGradient">
                ...
                <div class="textLabel">
                  ...
                  <p class="textLabel__name">Chringuito Paradise</p>
                </div>
              </div>
              <div class="gradient">
            ...
            <article>
              <div class="infoGradient">
                ...
                <div class="textLabel">
                  ...
                  <p class="textLabel__name">Silento</p>
                </div>
              </div>
              <div class="gradient">
